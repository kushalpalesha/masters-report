...
% Yang et al\cite{Jacqueline} present the policy agnostic programming paradigm for
% database-backed server-side applications. They present Jacqueline, a framework
% they developed by extending an existing MVC framework~\cite{django} with Jeeves.
